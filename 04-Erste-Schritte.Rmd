...
Wir können auch relativ simpel *Sequenzen* erstellen, zum Beispiel die Zahlen von 1 bis 100:
...
- `|` (oder auch `||`):
    ...
    - Da `|` auch wahr ist, wenn nur eine Seite wahr ist, ist es auch Grundlage für etlicher Mathe-/Logikwitze
    - `(1 < 3) | (5 < 10)` --> `TRUE`
    - `(5 < 2) | (2 < 10)` --> `TRUE`
- `xor()`:
