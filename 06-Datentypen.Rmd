...
## Tabellen <small>Just a bunch of vectors</small>
...
[^logic]: Das ist einer von diesesn Logikwitzen basierend auf dem Umstand, dass das logische *oder* (`|`) auch *wahr* ist, wenn beide Auswahlmöglichkeiten *wahr* sind.
