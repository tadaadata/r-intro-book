...
Okay, ein letzter Schritt: Wir wollen den Datensatz als `tibble` vorliegen haben. Das ist inhaltlich kein großer unterschied zu `data.frame`, aber sieht in der Konsole kompakter aus:
