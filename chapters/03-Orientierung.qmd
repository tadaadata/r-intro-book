...
knitr::include_graphics(here::here("images/rstudio_fresh.png"))
```
...
knitr::include_graphics(here::here("images/rstudio_new_project_0.png"))
```
...
knitr::include_graphics(here::here("images/rstudio_projects.png"))
```
...
knitr::include_graphics(here::here("images/rstudio_project_file.png"))
```
...
knitr::include_graphics(here::here("images/console_math_1.png"))
```
...
```{r, fig.cap="Plus was denn?!", echo=FALSE, out.width="90%"}
knitr::include_graphics(here::here("images/inkorrekt_terminiert1.png"))
```
...
knitr::include_graphics(here::here("images/text_editor_3.png"))
```
