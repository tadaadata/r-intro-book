...
Wir haben bereits Seiten wie [rdrr.io](https://rdrr.io/) erwähnt, wo ihr euch Dokumentation anschauen könnt. Unter *Dokumentation* verbirgt sich übrigens nichts weltbewegendes, in der Regel geht es nur darum wie einzelne Funktionen zu benutzen sind.
Diese Seiten sind im Wesentlichen aufgebohrte Versionen der Hilfe, die R von Haus aus mitbringt — allerdings mit bells & whistles in Form von schönerer Optik, erweiterter Suchfunktion, Verlinkungen etc.

Diie Hilfe findet ihr auf der rechten Seite in RStudio, unter dem `"Help"`-Tab:

```{r, echo=FALSE, fig.cap="Die Startseite der R-Hilfe"}
knitr::include_graphics(here::here("images/hilfe_0.png"))
```
