...
[ggplot2](https://ggplot2.tidyverse.org/) ist nicht nur ein R-Packages, es ist auch gleichzeitig eine Implementation des *Grammar of Graphics*. Das klingt fancy (ist es auch), heißt für uns aber in erster Linie nur, dass es gut durchdachter Kram ist.  
...
knitr::include_graphics(here::here("images/colorpicker.png"))
```
...
knitr::include_graphics(here::here("images/brewer_palettes.png"))
```
...
Also: Googlet was ihr machen wollt, und bookmarkt [ggplot2.tidyverse.org](https://ggplot2.tidyverse.org/).
