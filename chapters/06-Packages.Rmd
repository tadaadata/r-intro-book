...
Eine umfassende Dokumentation findet ihr unter <https://www.strengejacke.de/sjPlot/>, und die packages von Interesse installiert ihr wie folgt:
...
```{r sjplot_tables_1, eval = knitr::is_html_output()}
...
Eine Übersicht gibt es auf der Seite der Toolbox: <https://tadaatoolbox.tadaa-data.de>  
Beispielhaftes Testoutput findet sich [dort](https://tadaatoolbox.tadaa-data.de/articles/test_output.html), und eine Funktionsreferenz [gibt's da auch](https://tadaatoolbox.tadaa-data.de/reference/).
