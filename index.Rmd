...
date: "Stand: `r format(Sys.time(), '%d. %B %Y @ %H:%M Uhr (%Z)')`"
lang: de-DE
...
source("setup.R")
include_graphics("images/tadaa_thin_t.png")
```

# Vorwort {-}

Das hier wird gerade eine R-Einführung für Psychologiestudierende (und seit 2018 auch für Public HealtherInnen) so mit ganz ohne Vorwissen im Bereich Software oder Programmierung. Dieses Werk ist zum Einen die Grundlage für die R-Intro für Psychologiestudierende in *QM*, und zum Anderen auch das Referenzwerk für das R-Seminar im Rahmen des Statistikmoduls in Public Health.
