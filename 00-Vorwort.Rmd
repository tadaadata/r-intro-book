...
Die grobe Idee ist es, eine Präsentaion für die Übung zu haben, und zusätzlich eine long-form Intro als Nachschlagwerk und vertiefendes Material.  
...
Wir brauchen den ein oder anderen Datensatz für Übungszwecke und zu beispielhaften Veranschaulichung, und da es langweilig wird wenn wir immer wieder auf *NGO* zurückgreifen, haben wir auf [dieser netten Übersichtsseite](https://public.tadaa-data.de/data/readme.html) einige Datensätze bereitgestellt, die ihr euch runterladen könnt. Wie ihr die einlest, erfahrt ihr im Kapitel [Datenimport].

Als kleinen Spoiler ist hier der "mach, dass es funktioniert"-Code:

```{r intro_sampledata, warning=FALSE, message=FALSE, error=FALSE}
